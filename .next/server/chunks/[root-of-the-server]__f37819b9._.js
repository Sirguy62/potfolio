module.exports = [
"[project]/Desktop/CLI/Mixpal/my-app/.next-internal/server/app/api/hotels/nearby/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/Desktop/CLI/Mixpal/my-app/app/api/hotels/nearby/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const longitude = searchParams.get("lon") || searchParams.get("lng");
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$CLI$2f$Mixpal$2f$my$2d$app$2f$lib$2f$amadeus$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["amadeus"].get("v1/reference-data/locations/hotels/by-geocode", {
            latitude,
            longitude,
            radius,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$CLI$2f$Mixpal$2f$my$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: err?.description || err?.message || "Unknown error"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f37819b9._.js.map